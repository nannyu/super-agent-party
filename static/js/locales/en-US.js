...
Key3`,
        ...
        'soulxServiceNotice': 'Start the SoulX-FlashHead service first (streaming_server.py), default address ws://127.0.0.1:8765',
        'soulxServerUrl': 'Server URL',
        'soulxWindowWidth': 'Window Width',
        'soulxWindowHeight': 'Window Height',
        'soulxTransparentBg': 'Transparent background (server-side RVM matting, internet required on first use)',
